...
def create_denoise_ae(image_depth=100, epochs=10, keep_model=False):
    # Data collection and preprocessing
    DATA_FOLDER = '../data/images/size256/processed_images' #contains the class dir of 'processed_images'

    # Training and test data accumulator lists
    X = []
    y = []
    ...
    for f in all_images[0:image_depth]:
        ...
        img_noisy = skfilters.gaussian(img, sigma=6, multichannel=True)  
        X.append(img_noisy)
    ...
    layer_filters = [16,16,32,32,64,64,128,128]
